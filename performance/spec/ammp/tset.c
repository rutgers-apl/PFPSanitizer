...
/* SPEC add function protos to reduce compiler whinings jh/9/21/99 */
...
/* there must be atoms and they must be specified */
	numatom = a_number();
        /* SPEC - add a "1" here (and in the next 5 instances) to      */
        /*        remove warnings, but I don't think                   */
...
/* there must be atoms and they must be specified */
	numatom = a_number();
        /* SPEC - add a "1" here (and in the next 4 instances) to      */
        /*        remove warnings, but I don't think                   */
        /*        any callers actually look at this return value       */
        /*        - j.henning 21-sep-99                                */
	if( numatom <= 0) return 1;
...
#endif
{
	...
	numatm = a_number();
        ...
        /*        any callers actually look at this return value       */
        /*        - j.henning 21-sep-99                                */
	if( numatm <5 ) return 1; /* cant work if there aint enough atoms */
