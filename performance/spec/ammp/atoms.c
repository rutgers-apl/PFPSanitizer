...
*/
/*SPEC use modern style decl, not K&R, to avoid compiler warnings jh/9/24/99 */
...
*/
/*SPEC use modern declaration to match function proto jh/9/22/99 */
...
*/
/* SPEC call it void so that compilers won't complain jh/9/21/99 */
