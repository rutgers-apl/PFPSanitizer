...
typedef struct
  { complex m01,m02,m12; double m00im,m11im,m22im; double space; } anti_hermitmat;
...
*	file "s_m_vec.c"
* void scalar_mult_add_su3_vector( su3_vector *a, su3_vector *b, double s,
*	su3_vector *c)
*	file "s_m_a_vec.c", "s_m_a_vec.m4"
* void scalar_mult_sum_su3_vector( su3_vector *a, su3_vector *b, double s )
*	file "s_m_sum_vec.c", "s_m_sum_vec.m4"
* void scalar_mult_sub_su3_vector( su3_vector *a, su3_vector *b, double s,
*	su3_vector *c )
*	file "s_m_s_vec.c"
...
* void scalar_mult_add_wvec(  wilson_vector *src1,*src2, double s,
*           wilson_vector *dest)
*	file s_m_a_wvec.c
*	   dest <- src1 + s*src2
* void scalar_mult_addtm_wvec( wilson_vector *src1,*src2, double s,
*           wilson_vector *dest)
*	file s_m_atm_wvec.c
