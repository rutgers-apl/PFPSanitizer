...
labels = ["4-Core", "8-Core", "16-Core", "32-Core", "64-Core"]
i=0
k=0
...
i = 0
for line1 in fd_512:
    (bench_512, core1_512, core4_512, core8_512, core16_512, core32_512, core64_512, base_512)= string.split(line1, ':')
    benchmarks.append(bench_512)
    speedup_4 = float(core1_512)/float(core4_512)
    speedup_8 = float(core1_512)/float(core8_512)
    speedup_16 = float(core1_512)/float(core16_512)
    speedup_32 = float(core1_512)/float(core32_512)
    ...
    speedup_fpsanx_16.append(float(speedup_16))
    speedup_fpsanx_32.append(float(speedup_32))
...
avg_speedup_16 = geometric_mean(speedup_fpsanx_16)
print "avg_speedup_16:",avg_speedup_16
print "\n"
speedup_fpsanx_16.append(avg_speedup_16)

avg_speedup_32 = geometric_mean(speedup_fpsanx_32)
print "avg_speedup_32:",avg_speedup_32
print "\n"
speedup_fpsanx_32.append(avg_speedup_32)
...
hash_table_results.append(speedup_fpsanx_16)
hash_table_results.append(speedup_fpsanx_32)
